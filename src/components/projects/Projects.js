    ...
    <div className="project" id="project">
      <div className="project-container ">
        ...
        <div
          data-aos="fade-up"
          data-aos-duration="3000"
          className="project-container-row-1"
        >
          <div className="project-container-row-1v">
            <p className="project-container-row-1v__info_1">
              Note app là một ứng dụng mà bạn có thể ghi chú lại những việc muốn
              làm.
            </p>
            <img
              className="project-container-row-1v__img_1"
            ...
            <div className="project-container-row-1v__caption_1">
              ...
              <div className="project-container-row-1v__caption-text">
        ...
        >
          <div className="project-container-row-2v">
            ...
            <div className="project-container-row-2v__caption_2">
              ...
              <div className="project-container-row-2v__caption-text">
        ...
        >
          <div className="project-container-row-3v">
            ...
            <div className="project-container-row-3v__caption_3">
              ...
              <div className="project-container-row-3v__caption-text">
        ...
        >
          <div className="project-container-row-4v">
            ...
            <div className="project-container-row-4v__caption_4">
              ...
              <div className="project-container-row-4v__caption-text">
