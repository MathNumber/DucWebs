  ...
  return (
    <div className="skill" id="skill">
      <div data-aos="zoom-in">
        <h2 className="skill__title">Các ngôn ngữ từng học</h2>
      </div>
      <div data-aos="zoom-in" className="skill__container ">
        <div className="skill__container-row">
          <div className="skill__container-row-1">
            <div className="desc">
              <svg
                ...
                height="50"
                fill="#3C9488"
                className="skill__container-row-icon"
                viewBox="0 0 16 16"
              >
                <path
                  fill-rule="evenodd"
              ...
              <h3 className="skill__container-row-info">HTML & CSS</h3>
            </div>
          </div>

          <div className="skill__container-row-2">
            <div className="desc">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="50"
              ...
              <h3 className="skill__container-row-info">JAVASCRIPT</h3>
            </div>
          </div>

          <div className="skill__container-row-3">
            <div className="desc">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="50"
              ...
              <h3 className="skill__container-row-info">REACT JS</h3>
            </div>
          </div>
        </div>
      </div>
